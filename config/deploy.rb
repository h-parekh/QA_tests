...
set :branch, 'master'
set :tested_applications, ['classes', 'contentful', 'crawler', 'curate', 'dave', 'dec', 'gatekeeper', 'hesburghsite', 'hours', 'microfilms', 'osf', 'recommendationEngine', 'sipity', 'testApi', 'usurper', 'vatican', 'viceroy', 'webRenovation']
