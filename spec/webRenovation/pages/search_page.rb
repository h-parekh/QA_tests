  ...
  module Pages
    class SearchPage
      ...
      def valid_url?
        ...
        current_url == 'http://onesearch.library.nd.edu/primo_library/libweb/action/search.do?mode=Basic&vid=NDU&tab=nd_campus&' ||
        current_url == 'http://onesearch.library.nd.edu/primo_library/libweb/action/search.do?mode=Basic&vid=NDU&tab=ebooks&'
      end
      ...
      def correct_content?
        ...
        page.has_selector?('.active.tab.onesearch.EXLSearchTabTitle.EXLSearchTabLABELOneSearch') &&
        ...
        if current_url == 'http://onesearch.library.nd.edu/primo_library/libweb/action/search.do?mode=Basic&vid=NDU&tab=nd_campus&'
